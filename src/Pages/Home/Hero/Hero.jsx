            ...
            <div className="container d-flex align-items-center flex-column flex-sm-row py-5">
                <div>
                    ...
                    <p className="text-light">
                        Download full HD movies, web series and short films HD movies refer to films
                        that are available in high-definition resolution, providing a superior
                        visual experience with sharper images, vibrant colors, and enhanced detail.
                    </p>
